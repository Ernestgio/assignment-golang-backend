...
// GetSourceOfFundById provides a mock function with given fields: id
func (_m *SourceOfFundRepository) GetSourceOfFundById(id int) (*entity.SourceOfFund, error) {
	ret := _m.Called(id)

	var r0 *entity.SourceOfFund
	if rf, ok := ret.Get(0).(func(int) *entity.SourceOfFund); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
